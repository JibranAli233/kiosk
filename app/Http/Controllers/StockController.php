...
class StockController extends Controller
{
    ...
    public function calc_purchase_items($item_id){
        $data       = DB::table('purchase_has_items')
                        ->select(DB::raw('SUM(purchase_has_items.purchase_qty ) as purchase_qty'))
    ...
    public function calc_sell_items($item_id){
        $data       = DB::table('sell_has_items')
                        ->select(DB::raw('SUM(sell_has_items.sell_qty) as sell_qty'))
    ...
    public function list()
    {
        ...
        foreach ($record as $key => $value) {
            ...
            $stock_qty_int      = ($purchase_qty-$sell_qty) ;
            $stock_qty_dec      = ($purchase_qty-$sell_qty);
        ...
        // Assuming $array is your original array of items
        $data = collect($data)->sortBy('stock')->values()->all();
