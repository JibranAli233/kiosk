...
class ItemController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('items.create',compact('branches','companies','categories','manufacturers'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories     = Category::where('company_id',$company_id)->pluck('name','id')->all();
        $manufacturers  = Manufacturer::where('company_id',$company_id)->pluck('name','id')->all();
        return view('items.edit',compact('data','branches','companies','categories','manufacturers'));
