...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a  href="{{ route('types.index') }}" class="btn btn-primary btn-xs ml-auto">
                    ...
                    <!--begin::Form-->
                        {!! Form::model($data, ['method' => 'PATCH','id'=>'form','enctype'=>'multipart/form-data','route' => ['types.update', $data->id]]) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::select('parent_id', [0=>"--No parent--"]+$types,$data->parent_id, array('class' => 'form-control')) !!}
    ...
    {!! JsValidator::formRequest('App\Http\Requests\TypeRequest', '#form'); !!}
@endsection
