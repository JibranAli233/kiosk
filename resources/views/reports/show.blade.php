                                    ...
                                    <table class="table dt-responsive">
                                        ...
                                        <tbody> <?php $pBal = 0?>
                                            ...
                                            <?php
                                                ...
                                                $payment_detail  = isset($value->payment_detail) ? $value->payment_detail : NULL;
                                                $bill_id  = isset($value->bill_id) ? $value->bill_id : NULL;
                                                $bill_id  = isset($value->bill_id) ? $value->bill_id : NULL;
                                                $order_no  = isset($value->order_no) ? $value->order_no : NULL;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <th style="color:black !important;"> {{ isset($value->payment_detail) ? $value->payment_detail : ''}}
                                                        <?php 
                                                            if(($payment_detail != NULL) && ($bill_id !=NULL)){
                                                                echo ", ";
                                                            }
                                                        ?>
                                                        <?php
